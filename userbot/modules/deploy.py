...
async def _(event):
    ...
    animation_chars = [
        "Heroku Connecting To Latest Github Build (KykanoRobot/DEZKY-USERBOT)",
        ...
        "INFO - Dezky-Userbot: Logged in as 557667062",
        "INFO - Dezky-Userbot: Successfully...",
        "919852+00:00 app[worker.1]: 919 - Rose-Userbot -",
        "INFO - ⚡ Dezky-Userbot ⚡ ⚙️ V5.0 [TELAH DIAKTIFKAN!]",
        "**Build Succeeded**",
    ]
