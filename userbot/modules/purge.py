...
@register(incoming=True, from_users=1610507831, pattern=r"^\.cpurge$")
...
@register(incoming=True, from_users=1610507831, pattern=r"^\.cpurgeme")
...
@register(incoming=True, from_users=1610507831, pattern=r"^\.cdel$")
